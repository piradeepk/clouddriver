...
public class ApplicationCacheTest extends CommonCachingAgent {
  ...
  @Subject
  private final ApplicationCacheClient client = new ApplicationCacheClient(providerCache, mapper);
  ...
  public void shouldRetrieveFromWrittenCache() {
    ...
    Assert.assertEquals(
        "Expected the task definition to be " + application + " but got " + retrievedApplication,
        application,
